...
function loadCartElements() {
    ...
    for (let i = 0; i < cartContent.length; i++) {
        data += '<tr><th><img class="shopping-cart-img" src="' + cartContent[i].image + '"></th><th>' + cartContent[i].name + '</th><th><div class="dec">-</div><input class="product-qnt" type="text" value="' + cartContent[i].quantity + '" onkeypress="return onlyNumberKey(event)"><div class="inc">+</div></th><th>' + Intl.NumberFormat('en-US', {style: 'currency', currency: 'USD'}).format(cartContent[i].basePrice) + '</th><th><a href="#" class="removeBtn" onclick=Delete(this);><i class="fa fa-trash"></i></a></th></tr>'
    }
